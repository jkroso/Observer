...
define(['Topic', 'Subscription'], function (Topic, Subscription) { 'use strict';
    ...
    SignalTree.prototype = {
        ...
        // _Method_ __run__   
        // A quicker version of publish designed to trigger just the specified event i.e. no bubbling
        //   
        //   +   __String__ `topic` the event type
        //   +   __...?__ `data` any data you want passed to the callbacks  
        //   
        ...
        run : function ( topic, data ) {
            ...
            return this._emit([topicNode._listeners], data)
        },
        ...
        on : function (topics, context, callback, priority) {
            ...
            topics.split(' ').forEach(
                function (directions) {
                    this.get(directions, true).insertListener(listenerData)
                },
                this
            )
